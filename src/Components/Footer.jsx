...
const Footer = () => {
  return (
    <div className='w-full flex flex-col-reverse md:flex-row  justify-between items-center px-4 md:px-10 lg:px-24 xl:px-[209px] py-5 bg-purple-50 shadow-lg border-t border-purple-200 gap-4 md:gap-0 text-center md:text-left'>
